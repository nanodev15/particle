...
public:
  ...
  */
  ...
  ///Dessine un quadrilatère dans le buffer courant.
  void drawQuad(unsigned x1, unsigned y1,
		unsigned x2, unsigned y2,
		unsigned x3, unsigned y3,
		unsigned x4, unsigned y4
		);
  ///Dessine un quadrilatère plein dans le buffer courant.
  void fillQuad(unsigned x1, unsigned y1,
		unsigned x2, unsigned y2,
		unsigned x3, unsigned y3,
		unsigned x4, unsigned y4
		);
...
inline void XWindow::drawQuad(unsigned x1, unsigned y1,
			      unsigned x2, unsigned y2,
			      unsigned x3, unsigned y3,
			      unsigned x4, unsigned y4
			      ) {
  ...
  tab[4].x = x1;
  tab[4].y = y1;
  XDrawLines(dpy, pixm, gc, tab, 5, CoordModeOrigin);
}
inline void XWindow::fillQuad(unsigned x1, unsigned y1,
			      unsigned x2, unsigned y2,
			      unsigned x3, unsigned y3,
			      unsigned x4, unsigned y4
			      ) {
  ...
  tab[3].x = x4;
  tab[3].y = y4;
  XFillPolygon(dpy, pixm, gc, tab, 4, Convex, CoordModeOrigin);
}
